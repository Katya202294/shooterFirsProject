...
for i in range(1, 6):
    monster = Enemy('ufo.png', randint(80, win_width - 80), randint(0, 100), 1)
    monsters.add(monster)

asteroids = sprite.Group()
for i in range(1, 6):
    asteroid = Enemy('asteroid.png', randint(80, win_width - 80), randint(0, 100), 1)
...
while run:
    ...
    if not finish:
        ...
        if rel_time:
            ...
            if new_current_time - current_time < 2:
                font3 = font.Font('Arial', 20)
        ...
        lose_game = sprite.spritecollide(player, monsters, False) or lost >= max_lost
        if lose_game:
            finish = True 
